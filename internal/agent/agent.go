...
func New(cfg *config.Config) (*Agent, error) {
	...
	a.coord = coordinator.New(cfg.PodName, validator)
...
func (a *Agent) handleScheduleAssignment(ctx context.Context, sched *orbitv1.ProbeSchedule) (*orbitv1.ProbeScheduleResponse, error) {
